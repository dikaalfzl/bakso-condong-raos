...
import { Award, Users, Clock, MapPin, Grid, List } from "lucide-react";
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex justify-end mb-4">
              <button
                ...
                className={`p-2 rounded-l-md ${displayMode === 'grid' ? 'bg-primary-600 text-white' : 'bg-gray-200 text-gray-700'}`}
              >
                <Grid size={20} />
              </button>
              <button
                onClick={() => setDisplayMode('list')}
                className={`p-2 rounded-r-md ${displayMode === 'list' ? 'bg-primary-600 text-white' : 'bg-gray-200 text-gray-700'}`}
              >
                <List size={20} />
              </button>
            </div>
